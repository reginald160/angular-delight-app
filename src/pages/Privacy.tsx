      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-foreground/90">
          <section>
            ...
            <p>We are the data controller for the personal data we process. If you have any questions, contact our Data Protection Officer at <a href="mailto:admin@pathway-hub.com" className="text-primary underline">admin@pathway-hub.com</a>.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>To exercise any of these rights, email us at <a href="mailto:admin@pathway-hub.com" className="text-primary underline">admin@pathway-hub.com</a>. We will respond within 30 days.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <ul className="list-none space-y-1">
              <li>Data Protection Officer: <a href="mailto:admin@pathway-hub.com" className="text-primary underline">admin@pathway-hub.com</a></li>
