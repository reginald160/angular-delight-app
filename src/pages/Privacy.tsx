      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-foreground/90">
          <section>
            ...
            <p>
              UK Pathway Hub ("we", "us", "our") is committed to protecting your personal data.
              This Privacy Policy explains how we collect, use, store, and share your information
              when you use our career support and job application assistance services, in compliance
              with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018.
            </p>
            <p>
              We are the data controller for the personal data we process. If you have any questions,
              contact us at{' '}
              <a href="mailto:admin@pathway-hub.com" className="text-primary underline">
                admin@pathway-hub.com
              </a>
              .
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Profile Data:</strong> Industry, role preferences, location preferences, salary expectations,
                skills, work history, education, certifications, and portfolio links.
              </li>
              <li>
                <strong>Documents:</strong> CVs, cover letters, and other files you upload for career support.
              </li>
              <li>
                <strong>Application Details:</strong> Roles you approve for submission, application answers you provide,
                and any additional information needed to complete employer application forms.
              </li>
              <li>
                <strong>Payment Information:</strong> Billing details processed securely via Stripe (we do not store full card numbers).
              </li>
              <li>
                <strong>Communications:</strong> Messages sent through our support channels (email, chat, or in-app messaging).
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Cookies:</strong> Essential and analytics cookies (see Section 8).
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Contract Performance (Art. 6(1)(b)):</strong> To provide career support services, manage your account,
                and deliver the plan you subscribe to.
              </li>
              <li>
                <strong>Legitimate Interests (Art. 6(1)(f)):</strong> To improve our service, prevent fraud, and ensure platform security
                (balanced against your rights).
              </li>
              <li>
                <strong>Consent (Art. 6(1)(a)):</strong> For marketing communications and optional analytics (where applicable). You may withdraw
                consent at any time.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Provide and personalise our career support services (CV optimisation, job search support, and interview preparation).</li>
              <li>Process payments and manage subscriptions.</li>
              <li>Prepare and submit job applications based on your approved job preferences and the information you provide.</li>
              <li>Track applications and update your dashboard with progress where information is available.</li>
              <li>Communicate service updates, notifications, and support responses.</li>
              <li>Improve platform functionality and user experience.</li>
              <li>Detect and prevent fraudulent or unauthorised activity.</li>
              <li>Comply with legal and regulatory obligations.</li>
            </ul>
            <p className="mt-4">
              <strong>Important:</strong> We provide professional support services only. We do not guarantee interviews or employment outcomes.
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Service Providers:</strong> Payment processors (Stripe), cloud hosting, email/SMS providers — all bound by data processing agreements.
              </li>
              <li>
                <strong>Employers and Recruitment Platforms:</strong> When you approve specific roles, we may submit your CV and relevant profile information
                to employers or application systems to complete your job applications.
              </li>
              <li>
                <strong>Legal Authorities:</strong> When required by law, court order, or to protect our legal rights.
              </li>
              <li>
                <strong>AI Support Tools:</strong> We may use tools to help draft or refine CV content and application text. Where used, we aim to minimise
                personal data shared and apply appropriate safeguards. We do not allow third-party AI providers to use your identifiable personal data
                to train their models unless you explicitly consent.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Your data is primarily stored within the United Kingdom and European Economic Area. Where data is transferred outside the UK/EEA,
              we ensure appropriate safeguards are in place, such as:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>UK adequacy decisions.</li>
              <li>International Data Transfer Agreement (IDTA) or UK Addendum to EU Standard Contractual Clauses (as applicable).</li>
              <li>Additional technical and organisational safeguards where required.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Account Data:</strong> Retained for the duration of your account and up to 2 years after deletion where needed for legal or dispute purposes.
              </li>
              <li>
                <strong>Payment Records:</strong> Retained for up to 7 years as required for HMRC record-keeping.
              </li>
              <li>
                <strong>Support Messages:</strong> Retained for up to 1 year after the last interaction.
              </li>
              <li>
                <strong>CVs and Documents:</strong> Deleted within 30 days of account closure unless you request otherwise or retention is needed for legal reasons.
              </li>
              <li>
                <strong>Application Logs:</strong> We may retain a basic audit trail of submissions (date/time, employer name, role title) for service delivery and dispute handling.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Analytics Cookies:</strong> Help us understand how users interact with our platform (opt-in where required).
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Rights related to automated decisions (Art. 22):</strong> Where applicable, request human review of decisions made solely by automated means.
              </li>
            </ul>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Encryption in transit (TLS/SSL) and at rest where appropriate.</li>
              <li>Access controls and role-based permissions.</li>
              <li>Monitoring and protection against unauthorised access.</li>
