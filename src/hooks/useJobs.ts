...
export function useJobs() {
  ...
  const [userCVAnalysis, setUserCVAnalysis] = useState<CVAnalysis | null>(null);
...
//   const result = await authApi.getCVAnalysis();

//   if (result.error || !result.data) {
//     console.error("Error fetching CV analysis:", result.error);
//     setUserCVAnalysis(null);
//     return;
//   }

//   setUserCVAnalysis(result.data);
// };
  ...
  const fetchUserCV = async () => {
    ...
    const cvAnalysis = await authApi.getCVAnalysis();

    if (cvAnalysis.error || !cvAnalysis.data) {
      console.error('Error fetching cvAnalysis:', cvAnalysis.error);
      setUserCVAnalysis(null);
    } else {
      setUserCVAnalysis(cvAnalysis.data);
    }
    ...
    setUserCV({
      ...
      analysis_result: cvAnalysis.data || null,
      is_primary: true,
